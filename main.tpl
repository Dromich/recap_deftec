                        ...
                        <div class="col-md-10">
                            ...
                            <div class="nav-wrap">                                
                                <nav id="mainnav" class="mainnav">
                                    <ul class="menu"> 
                                        <li>
                                            <a href="/" [aviable=main]class="active"[/aviable]>Home</a>
                                        </li>

                                        <li><a id="prooo" href="/#product">Products</a>
                                            <ul class="submenu">
                                                <li><a href="/ground_vehicles_and_equipment.html">Ground Vehicles and Equipment</a></li>
												<li><a href="/helicopter-aircraft.html">Helicopter & Aircraft</a></li>
												<li><a href="/ships-and-maritime-equipment.html">Ships and Maritime Equipment</a></li>
												<li><a href="/products/ground-radars/">Ground Radars</a></li>
												<li><a href="/products/electronic-components/">Electronic components</a></li>
                                                <li><a href="/products/air-traffic-control/">ATC</a></li>
												<li><a href="/products/communications-equipment/">Communications Equipment</a></li>
												<li><a href="/satellite-equipment-space-vessels.html">Space Solutions</a></li>
                                                <li><a href="/electronic-beam-welding.html">Electronic Beam Welding</a></li>
												<li><a href="/electronic-counter-measures.html">Electronic Counter-measures</a></li>
												<li><a href="/products/cbrn-protection/">CBRN Protection</a></li>
                                                <li><a href="/products/unmanned-aerial-systems/">Unmanned Aerial Systems</a></li>
												<li><a href="/law-enforcement.html">Law Enforcement</a></li>
												<!--li><a href="/air-defence-systems.html">Air Defence Systems</a></li-->
												<li><a href="/products/industrial-explosives/">Industrial Explosives</a></li>
                                                <li><a href="/products/medical-solutions/">Medical Solutions</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li>
											<a href="/oil-gas.html">Oil & Gas</a>
                                             <ul class="submenu">
												...
												<li><a href="/templates/Solution/img/oilgas.pdf">Prospecting, exploration and development oil and gas fields</a></li>
                                            </ul>
										</li>
...
<div class="flat-row pad-bottom0px">
			...
			<div class="flat-wrapper">
				...
				<div class="flat-services">
					...
					<div class="slotholder">
						...
						<div class="tp-bgimg">
							<div class="row">						
								...
								<div class="gr-button"><a class="button scheme2" href="/video.html">Video</a></div>
					...
					<div class="gr-button">
							...
							</div><span >Download PDF or PPT presentations for some of our hi-tech products.</span></div>
							</div>
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/car.jpg" alt="GROUND VEHICLES AND EQUIPMENT">
			</div>
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/helicopter.png" alt="HELICOPTER & AIRCRAFT">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/boat.jpg" alt="SHIPS AND MARITIME EQUIPMENT">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/comp.jpg" alt="ELECTRONIC COMPONENTS">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/air.png" alt="AIR TRAFFIC CONTROL">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/techno.jpg" alt="COMMUNICATIONS EQUIPMENT">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/space.jpg" alt="SATELLITE EQUIPMENT & SPACE VESSELSs">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/beam.jpg" alt="ELECTRONIC BEAM WELDING">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/electronic.jpg" alt="ELECTRONIC COUNTER-MEASURES">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/swissdrones-1.png" alt="UNMANNED AERIAL SYSTEMS">
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
               <div id="new_expo" style="background-image: url(/templates/Solution/img/slides/explosion.jpg);background-size: cover;" ></div>
	...
	<div class="imagebox">
		<div class="box-wrapper">
			<div class="box-image">
				<img src="/templates/Solution/img/category/medicine.jpg" alt="Medical Solutions">
        ...
        <tr>
            <td style="width: 100.0000%;">
                <div style="text-align: center;">
                    <a class="highslide" href="http://deftech-ltd.legranchio.com.ua/uploads/posts/2017-11/1509715911_protection.jpg" target="_blank"><img src="http://deftech-ltd.legranchio.com.ua/uploads/posts/2017-11/medium/1509715911_protection.jpg" alt="" class="fr-dib"></a>
                   
                  
                </div>
                <div style="text-align: center;"><b>SYSTEM GENERAL DESCRIPTION</b></div>The system combines separate components to a complex, which performs helicopter protection probability up to 95%.
                <br>Active jammer Adros KT-01AVE is the main component, which radiates specially organized disturbance IR signal to interfere IR homing heads operation.
                <br>Another important component is KUV 26-50 (or AV-26V) flare dispenser. Specially organized flares deceive any IR homing head (including two-color and pulse-length modulated).
                <br>Exhaust suppressors decrease helicopter IR visibility and accordingly decrease IR missile allowed launch range.
